...
const Update: FC<IModal> = (props) => {
  ...
  const SavePost = () => {
    ...
    previousPosts[props.indexPost!] = editedPost;
    ...
    <FormContainer>
        ...
        <Form>
          {inputs.map((input: string, index: number) => (
            <Input
              ...
              defaultValue={(fields as any)[input]}
            />
          ))}
        </Form>
      )}
      ...
      {submitted && (
        ...
        >
          ...
          <Typography>Post edited successfully !</Typography>
